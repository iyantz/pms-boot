package com.yantz.boot.core.aspect;
...
import com.yantz.boot.common.util.IPUtils;
...
public class LogAspect {
     ...
     * 切点
     */
    @Pointcut("@annotation(com.yantz.boot.common.annotation.Log)")
    ...
    public void doAfterReturning(JoinPoint joinPoint, com.yantz.boot.common.annotation.Log logAnnotation, Object jsonResult) {
     ...
     */
    private void saveLog(final JoinPoint joinPoint, final Exception e, Object jsonResult, com.yantz.boot.common.annotation.Log logAnnotation) {
